...
#[cfg(test)]
mod test {
    use crate::{db::postgres_user_stock_trade_repository::PostgresUserStockTradeRepository, models::stock_trade::NewStockTrade};
    ...
    async fn test_get_tickers_returns_all_unique_tickers(pool :sqlx::PgPool) {
        ...
        repo1.save_trade(NewStockTrade {
        ...
        repo2.save_trade(NewStockTrade {
            ticker: "AAPL".to_string(),
            trade_type: "BUY".to_string(),
            trade_date: "2024-01-01".to_string(),
            units: 10.0,
